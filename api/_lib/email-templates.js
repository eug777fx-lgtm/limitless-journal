...
<!-- FOOTER -->
<tr><td align="center" bgcolor="#000000" style="background-color:#000000;padding:24px 40px;border-top:1px solid #1a1a1a;">
...
const statCard = (label, value, color) => `<td width="48%" align="center" bgcolor="#111111" style="background-color:#111111;border:1px solid #1f1f1f;border-radius:8px;padding:18px 12px;">
...
const accentCard = (border, textColor, text) => `<table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#111111" style="background-color:#111111;border:1px solid #1f1f1f;border-left:3px solid ${border};border-radius:8px;margin-bottom:24px;">
...
<tr><td align="center" bgcolor="${bg}" style="background-color:${bg};border-radius:8px;padding:16px 32px;">
...
<td width="24" height="24" align="center" valign="middle" bgcolor="#1a1a1a" style="background-color:#1a1a1a;border-radius:12px;"><span style="color:#aaffa0;font-size:11px;font-weight:700;font-family:${FONT};">${n}</span></td>
...
function approvedEmail(user = {}) {
  ...
  const feature = (glyph, label) => `<td width="33%" align="center" bgcolor="#111111" style="background-color:#111111;border:1px solid #1f1f1f;border-radius:8px;padding:16px 12px;">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#111111" style="background-color:#111111;border:1px solid #1f1f1f;border-radius:8px;margin-bottom:24px;">
<tr><td style="padding:20px 24px;">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin:24px 0;"><tr><td height="1" bgcolor="#1a1a1a" style="background-color:#1a1a1a;height:1px;line-height:1px;font-size:0;">&nbsp;</td></tr></table>
<table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#111111" style="background-color:#111111;border:1px solid #1f1f1f;border-radius:8px;">
<tr><td style="padding:20px 24px;">
